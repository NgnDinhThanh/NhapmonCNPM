 ...
 */
public class AddNewHoatDong extends javax.swing.JFrame {

    /**
     * Creates new form AddNewHoatDong
     */
    private HoatDongPanelController parentController;
    private JFrame parentFrame;
    private HoatDongBean hoatDongBean;
    private AddNewHoatDongController controller;

    public AddNewHoatDong(HoatDongPanelController parentController, JFrame parentJFrame) {
        this.parentController = parentController;
        this.parentFrame = parentJFrame;
        this.parentFrame.setEnabled(false);
        this.hoatDongBean = new HoatDongBean();
        initComponents();
        setTitle("Thêm mới hoạt động");
        setDefaultCloseOperation(JFrame.DO_NOTHING_ON_CLOSE);
        controller = new AddNewHoatDongController();
    ...
    public AddNewHoatDong(JFrame parenJFrame) {
        ...
        this.addWindowListener(new WindowAdapter() {
            @Override
            public void windowClosing(WindowEvent e) {
                if (JOptionPane.showConfirmDialog(null, "Bạn chắc chắn muốn đóng??", "Warning!!", JOptionPane.YES_NO_OPTION) == 0) {
                    close();
                }
            }
    ...
    private boolean validateValueInForm() {
        ...
        if (jendDate.getDate().before(jstartDate.getDate())) {
            JOptionPane.showMessageDialog(rootPane, "Ngày bắt đầu hoạt động không thể muộn hợn ngày kết thúc", "Warning", JOptionPane.WARNING_MESSAGE);
            return false;
        }
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(jendDate, javax.swing.GroupLayout.PREFERRED_SIZE, 300, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(18, 18, 18)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGap(28, 28, 28)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jstartDate, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel4, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jLabel8, javax.swing.GroupLayout.PREFERRED_SIZE, 31, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(34, 34, 34)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(jendDate, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void AddbtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddbtnActionPerformed
        if (validateValueInForm()) {
            HoatDongModel temp = this.hoatDongBean.getHoatDongModel();
            temp.setTenHoatDong(txbName.getText());
            temp.setTuNgay(jstartDate.getDate());
            temp.setDenNgay(jendDate.getDate());
            temp.setIdNguoiTao(LoginController.currentUser.getID());
            try {
                if (this.controller.addNewHoatDong(this.hoatDongBean)) {
                    JOptionPane.showMessageDialog(null, "Thêm mới thành công!!");
                    parentController.refreshData();
                    ThongTinSuDungJFrame thongTinSuDungJFrame = new ThongTinSuDungJFrame(this);
                    thongTinSuDungJFrame.setLocationRelativeTo(null);
                    thongTinSuDungJFrame.setResizable(false);
                    thongTinSuDungJFrame.setVisible(true);
                    close();
                }
            } catch (Exception e) {
